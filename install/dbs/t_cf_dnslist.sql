...
CREATE TABLE dnslist (
  ...
  type    varchar(20) NOT NULL DEFAULT 'blocklist',
...
-- wantlists
INSERT INTO dnslist SET name='BSP', url='sa-trusted.bondedsender.org.', type='wantlist', active=1;
INSERT INTO dnslist SET name='IADB', url='iadb.isipp.com.', type='wantlist', active=1;
INSERT INTO dnslist SET name='HABEAS', url='sa-accredit.habeas.com.', type='wantlist', active=1;
INSERT INTO dnslist SET name='DNSWL', url='list.dnswl.org.', type='wantlist', active=1;
