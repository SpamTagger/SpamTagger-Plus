...
CREATE TABLE antispam (
  ...
  enable_wantlists              tinyint(1) NOT NULL DEFAULT '0',
  enable_warnlists               tinyint(1) NOT NULL DEFAULT '0',
  enable_blocklists              tinyint(1) NOT NULL DEFAULT '0',
  tag_mode_bypass_wantlist      tinyint(1) NOT NULL DEFAULT '1',
  wantlist_both_from            tinyint(1) NOT NULL DEFAULT '0',
  trusted_ips                    blob,
  html_wl_ips                    blob,
