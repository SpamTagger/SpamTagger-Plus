...
ALTER TABLE `st_config`.`user_pref` ADD COLUMN `allow_newsletters` TINYINT(1) NOT NULL DEFAULT 1 AFTER `bypass_filtering`;

ALTER TABLE `st_config`.`domain_pref` ADD COLUMN `allow_newsletters` TINYINT(1) NOT NULL DEFAULT 1 AFTER `require_outgoing_tls`;
...
ALTER TABLE `st_spool`.`spam_a` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0'AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_b` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_c` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_d` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_e` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_f` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_g` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_h` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_i` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_j` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_k` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_l` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_m` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_n` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_o` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_p` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_q` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_r` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_s` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_t` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_u` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_v` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_w` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_x` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_y` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_z` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_num` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
ALTER TABLE `st_spool`.`spam_misc` 
ADD COLUMN `is_newsletter` ENUM('1', '0') NOT NULL DEFAULT '0' AFTER `M_globalscore`;
